...
- Provide additional context in the systemPrompt to the agent.
- Stream commands output in real time.
- Add spinner for a continuous task.

## v0.4.0

### New Features

- Added Agent Mode for interactive task execution (`volt agent`)
- Introduced Prompt History feature to view and rerun past prompts (`volt history`)

### Refactoring

- Performed general code cleanup and improvements
- Restructured internal directory layout

### Documentation

- Added documentation for Agent Mode and updated other sections
...
- Added Chat Mode Usage documentation
- Added Command Reference documentation and included more commands
- Added Quickstart Guide
- Added Changelog content to the documentation site

### Bug Fixes

- Fixed version check (`volt -v` / `volt --version`) to run before full application initialization

### Refactoring

- Restructured documentation files and improved command display

### Chores

- Updated dependencies across project workspaces
